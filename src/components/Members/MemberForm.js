  ...
  <div class="bdi-table-line bdi-table-line-open mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
    <div class="bdi-table-line-fields mdl-cell mdl-cell--7-col mdl-cell--11-col-desktop mdl-cell--3-col-phone mdl-grid">            
      ...
      <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-desktop mdl-cell--2-col-phone">
        ...
        <form action="#">
          <div class="mdl-textfield mdl-js-textfield is-upgraded" data-upgraded=",MaterialTextfield">
            <input class="mdl-textfield__input" type="text" id="member4role">
          </div>
        </form>
      </div>
      <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-desktop mdl-cell--2-col-phone">
      ...
      <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-desktop mdl-cell--2-col-phone">
        ...
        <form action="#">
          <div class="mdl-textfield mdl-js-textfield is-upgraded" data-upgraded=",MaterialTextfield">
            ...
            <label class="mdl-textfield__label" for="member4mail">Mail</label>
          </div>
        </form>
      </div>
      <div class="mdl-cell mdl-cell--4-col mdl-cell--3-col-desktop mdl-cell--2-col-phone">
    ...
    <div class="bdi-table-line-edit mdl-cell mdl-cell--1-col mdl-grid">
      <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon" id="memberbtn4" data-upgraded=",MaterialButton,MaterialRipple">
        ...
        <span class="mdl-button__ripple-container"><span class="mdl-ripple is-animating" style="width: 92.5097px; height: 92.5097px; transform: translate(-50%, -50%) translate(15px, 14px);"></span></span></button>
      <div class="mdl-menu__container is-upgraded" style="right: 73.25px; top: 856px; width: 124px; height: 112px;"><div class="mdl-menu__outline mdl-menu--bottom-right" style="width: 124px; height: 112px;"></div><ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--bottom-right mdl-js-ripple-effect--ignore-events" for="memberbtn4" data-upgraded=",MaterialMenu,MaterialRipple" style="clip: rect(0px, 124px, 0px, 124px);">
