...
class MigrationCommand extends Command {
  ...
  public function fire() {
    ...
    $this->info("Tables: $permissionsTable, $permissionRoleTable");

    $message = "A migration that creates '$permissionsTable', '$permissionRoleTable'" .
    ...
    if ($this->confirm("Proceed with the migration creation? [Yes|no]", "Yes")) {
      ...
      if ($this->createMigration($permissionsTable, $permissionRoleTable)) {
  ...
  protected function createMigration($permissionsTable, $permissionRoleTable) {
    ...
    $data = compact('permissionsTable', 'permissionRoleTable');
